...
#define cpe_array_init(arr) \
    (cpe_raw_array_init(cpe_array_to_raw(arr), cpe_array_element_size(arr)))
#define cpe_array_done(arr) \
    (cpe_raw_array_done(cpe_array_to_raw(arr)))
...
#define cpe_array_set_done(arr, d) \
    (cpe_raw_array_set_done(cpe_array_to_raw(arr), (d)))
